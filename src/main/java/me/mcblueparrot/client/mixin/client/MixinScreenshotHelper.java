...
import v1_8_9.net.minecraft.client.renderer.texture.TextureUtil;
import v1_8_9.net.minecraft.client.shader.Framebuffer;
import v1_8_9.net.minecraft.event.ClickEvent;
import v1_8_9.net.minecraft.util.ChatComponentText;
import v1_8_9.net.minecraft.util.ChatComponentTranslation;
import v1_8_9.net.minecraft.util.ChatStyle;
import v1_8_9.net.minecraft.util.EnumChatFormatting;
import v1_8_9.net.minecraft.util.IChatComponent;
import v1_8_9.net.minecraft.util.ScreenShotHelper;
