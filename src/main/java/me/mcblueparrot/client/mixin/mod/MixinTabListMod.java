...
import v1_8_9.net.minecraft.network.NetworkManager;
...
import v1_8_9.net.minecraft.client.gui.GuiPlayerTabOverlay;
import v1_8_9.net.minecraft.client.network.NetworkPlayerInfo;
...
public class MixinTabListMod {
	...
	public static class MixinGuiPlayerTabOverlay {
		...
		@Redirect(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", at = @At(value = "INVOKE", target = "Lv1_8_9/net/minecraft/client/gui/FontRender" +
		...
		@Redirect(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", at = @At(value = "INVOKE", target = "Lv1_8_9/net/minecraft/client/multiplayer/" +
				"WorldClient;getPlayerEntityByUUID(Ljava/util/UUID;)Lv1_8_9/net/minecraft/entity/player/EntityPlayer;"))
		...
		@Redirect(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", at = @At(value = "INVOKE", target = "Lv1_8_9/net/minecraft/client/Minecraft;" +
		...
		@Redirect(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", at = @At(value = "INVOKE", target = "Lv1_8_9/net/minecraft/network/" +
		...
		@ModifyConstant(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", constant = @Constant(intValue = Integer.MIN_VALUE))
		...
		@ModifyConstant(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", constant = @Constant(intValue = 553648127))
		...
		@Redirect(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", at = @At(value = "FIELD", target = "Lv1_8_9/net/minecraft/client/gui/" +
				"GuiPlayerTabOverlay;header:Lv1_8_9/net/minecraft/util/IChatComponent;"))
		...
		@Redirect(method = "renderPlayerlist(ILv1_8_9/net/minecraft/scoreboard/Scoreboard;Lv1_8_9/net/minecraft/scoreboard/ScoreObjective;)V", at = @At(value = "FIELD", target = "Lv1_8_9/net/minecraft/client/gui/" +
				"GuiPlayerTabOverlay;footer:Lv1_8_9/net/minecraft/util/IChatComponent;"))
		...
		@Inject(method = "drawPing(IIILv1_8_9/net/minecraft/client/network/NetworkPlayerInfo;)V", at = @At("HEAD"), cancellable = true)
				...
				if(TabListMod.instance.pingType == TabListMod.PingType.NUMERAL) {
					...
					mc.fontRendererObj.drawString(pingText,
							(p_175245_2_ + p_175245_1_ - (mc.fontRendererObj.getStringWidth(pingText) * scale)) / scale -
									2, p_175245_3_ / scale + 4, colour, TabListMod.instance.textShadow);
